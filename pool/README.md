...
> Mesma "família" visual e técnica do app **Meu Financeiro**, mas é um **projeto separado** (repo/pasta próprios e projeto Supabase próprio). Nada aqui mexe no app financeiro pessoal.
